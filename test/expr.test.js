...
describe('expr', () => {
    ...
    test('desc-call-order', () => {
        ...
        expect(gr.b.map((f) => f.name)).toEqual(['Min']);
        g = Gubu({ a: Max(1) });
        expect(g({ a: 1 })).toEqual({ a: 1 });
        ...
        expect(gr.b.map((f) => f.name)).toEqual(['Max']);
        ...
        expect(gr.b.map((f) => f.name)).toEqual(['Max', 'Min']);
        ...
        expect(gr.b.map((f) => f.name)).toEqual(['Min', 'Max']);
