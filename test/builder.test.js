...
const { Above, After, All, Any, Before, Below, Check, Closed, Define, Default, Empty, Exact, Max, Min, Never, Len, One, Open, Optional, Refer, Rename, Required, Skip, Some, Value, } = Gubu;
class Foo {
    constructor(a) {
        this.a = -1;
        this.a = a;
